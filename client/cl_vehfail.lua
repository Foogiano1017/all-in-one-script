...
cfg = {
	...
	engineDamageExponent = 0.1,					-- How much should the handling file deformation setting be compressed toward 1.0. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	torqueMultiplierEnabled = true,				-- Decrease engine torge as engine gets more and more damaged
	weaponsDamageMultiplier = 0.6,				-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
	...
	degradingHealthSpeedFactor = 200,			-- Speed of slowly degrading health, but not failure. Value of 10 means that it will take about 0.25 second per health point, so degradation from 800 to 305 will take about 2 minutes of clean driving. Higher values means faster degradation
	degradingFailureThreshold = 860.0,			-- Below this value, slow health degradation will set in
...
repairCfg = {
	...
	--	{name="Mechanic", id=446, r=27.0, x=1915.0,  y=3729.0,  z=32.0},	-- Otto's Auto Parts, Sandy Shores (too many in a close area)
		{name="Mechanic", id=446, r=45.0, x=-29.0,   y=-1665.0, z=29.0},	-- Mosley Auto Service, Strawberry
	--	{name="Mechanic", id=446, r=44.0, x=-212.0,  y=-1378.0, z=31.0},	-- Glass Heroes, Strawberry (Benny's is next door)
	...
	--	{name="Mechanic", id=446, r=25.0, x=437.0,   y=3568.0,  z=38.0}		-- Auto Shop, Grand Senora Desert
		{name="Mechanic", id=446, r=25.0, x=2456.6,  y=-384.6,  z=93.3},	-- SAHP HQ
		{name="Mechanic", id=446, r=25.0, x=463.3,   y=-1017.1, z=28.1},	-- LSPD Mission Row
		{name="Mechanic", id=446, r=25.0, x=871.7,   y=-1350.2, z=26.3}     -- LSPD La Mesa
	},
